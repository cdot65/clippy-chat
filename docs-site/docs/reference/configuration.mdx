...
| `VLLM_BASE_URL` | URL | — | `http://vllm-qwen36.vllm.svc.cluster.local:8000` |
| `VLLM_MODEL` | string | — | `qwen36-hauhaucs` |
...
VLLM_BASE_URL=http://vllm-qwen36.vllm.svc.cluster.local:8000
VLLM_MODEL=qwen36-hauhaucs
