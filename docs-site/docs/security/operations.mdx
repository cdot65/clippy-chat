...
- `clippy-mcp-client` is a OnePasswordItem projected from the **Truffles** vault.
...
1. Create/rotate the destination credential in Keycloak and its scoped 1Password item.
